 # Ronit Saxena
   ...
   [![Azure DP-100](https://img.shields.io/badge/Azure-Data%20Scientist-0078D4?style=for-the-badge&logo=microsoftazure)](https://learn.microsoft.co
  m/en-us/certifications/azure-data-scientist/)
   ...
   **Repo:** [clinical-agents](https://github.com/ronit22203/clinical-agents)
   ...
   Production platform for clinical research AI where agent behavior, tool selection, model parameters, and workflow routing are defined entirely
  in YAML — no source code changes required. Runs on two runtimes from one config: LangGraph ReAct (low latency) and Temporal Workflows (durable,
  auditable, human-in-the-loop).
   ...
   **Design Doc:** [ronitsaxena.in](https://www.ronitsaxena.in/media/statics/ingestion_layer_casestudy.pdf)
   ...
   HIPAA compliant knowledge base: **Neo4j** clinical graphs + **Qdrant** semantic search. Transforms unstructured medical PDFs into production
  intelligence while maintaining data sovereignty.
   ...
   **Status:** Fully containerized, regulated-environment ready.
   ...
   |:---|---|---|
   | [clinical-agents](https://github.com/ronit22203/clinical-agents) | LangGraph, Temporal, Ollama | Config-driven clinical research AI, dual
  runtime, HITL |
   | [PredictML-Production](https://github.com/ronit22203/PredictML-Production) | XGBoost, SHAP, FastAPI | Two-stage hospital no-show/delay
  prediction |
   | [Medical-RAG-Ingestion](https://github.com/ronit22203/Medical-RAG-Ingestion) | Neo4j, Qdrant, Presidio | Hybrid Graph-Vector RAG with PII
  redaction |
   | [Image-Reasoning-Pipeline](https://github.com/ronit22203/Image-Reasoning-Pipeline) | CLIP, Policy Engine | Deterministic pre-LLM vision
  intelligence |
   ...
   [![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ronits
  axena)
